...
using HomeWork_Base.Data;
using HomeWork_Base.Models;

namespace HomeWork_Base.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Books.Include(b => b.Author).Include(b => b.Theme);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ShortDesc,Pages,Price,PublishDate,AuthorId,ThemeId")] Book book)
        {
            ...
            ViewData["ThemeId"] = new SelectList(_context.Themes, "Id", "Name", book.ThemeId);
            return View(book);
        }
